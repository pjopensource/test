...
function get_brands($cat = 0, $app = 'brand')
{
    ...
    $sql = "SELECT b.brand_id, b.brand_name, b.brand_logo, b.brand_desc, b.sort_order, COUNT(*) AS goods_num, IF(b.brand_logo > '', '1', '0') AS tag ".
...
function get_package_goods($package_id, $package_attr_id='')
{
    ...
    $sql = "SELECT pg.goods_id, g.goods_name, pg.goods_number, p.goods_attr, p.product_number, p.product_id
            ...
            WHERE pg.package_id = '$package_id' $sql_package_attr_id "; //有修改 by www.jfsoo.com 注意最后那个 $sql_package_attr_id
    if ($package_id == 0)
    {
