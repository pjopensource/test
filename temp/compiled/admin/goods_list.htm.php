...
?>
  <tr>
    ...
    <td align="center">
	  ...
	  <a href="comment_collect.php?act=comment&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" ><img src="images/comment_icon.png"  border="0"/></a>
      ...
      <a href="product_spec_pic.php?act=list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" title="<?php echo $this->_var['lang']['specification_pic']; ?>"><img src="images/guigou_icon.png" width="16" height="16" border="0" /></a><?php else: ?><img src="images/empty.gif" width="16" height="16" border="0" />
	  <?php endif; ?>
