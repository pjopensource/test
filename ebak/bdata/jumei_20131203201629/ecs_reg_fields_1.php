...
E_D("replace into `ecs_reg_fields` values('2','QQ','0','1','1','1');");
E_D("replace into `ecs_reg_fields` values('3','办公电话','0','0','1','0');");
E_D("replace into `ecs_reg_fields` values('4','家庭电话','0','1','1','1');");
E_D("replace into `ecs_reg_fields` values('5','手机','0','1','1','1');");
