...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','拇指家-搜虎精品社区www.souho.net|www.souho.cc提供源码','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','拇指家-搜虎精品社区www.souho.net|www.souho.cc提供本源码','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','拇指家-搜虎精品社区www.souho.net|www.souho.cc提供程序','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','红星美凯龙 建材 家具 家居 综合购物类网站','1');");
E_D("replace into `ecs_shop_config` values('105','1','shop_country','manual','','','1','1');");
E_D("replace into `ecs_shop_config` values('106','1','shop_province','manual','','','16','1');");
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','220','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','南京市秦淮区卡子门大街29号','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','11111','1');");
...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','11111','1');");
...
E_D("replace into `ecs_shop_config` values('118','1','shop_logo','file','','../themes/{\$template}/images/','../themes/jumei/images/logo.gif','1');");
...
E_D("replace into `ecs_shop_config` values('121','1','shop_notice','textarea','','','','1');");
...
E_D("replace into `ecs_shop_config` values('211','2','integral_scale','text','','','0','1');");
E_D("replace into `ecs_shop_config` values('212','2','integral_percent','text','','','0','1');");
E_D("replace into `ecs_shop_config` values('213','2','sn_prefix','text','','','MZJ','1');");
...
E_D("replace into `ecs_shop_config` values('224','2','upload_size_limit','options','-1,0,64,128,256,512,1024,2048,4096','','-1','1');");
E_D("replace into `ecs_shop_config` values('226','2','cron_method','select','0,1','','0','1');");
E_D("replace into `ecs_shop_config` values('227','2','comment_factor','select','0,1,2,3','','3','1');");
...
E_D("replace into `ecs_shop_config` values('239','2','certificate_id','hidden','','','1260998535','1');");
E_D("replace into `ecs_shop_config` values('240','2','token','hidden','','','25b595d17762b8fcf02edd4ab6e6b4563948a3d19f9dcf65e8e7971ffc83216d','1');");
E_D("replace into `ecs_shop_config` values('241','2','certi','hidden','','','http://service.shopex.cn/openapi/api.php','1');");
E_D("replace into `ecs_shop_config` values('242','2','send_verify_email','select','1,0','','1','1');");
...
E_D("replace into `ecs_shop_config` values('304','3','thumb_width','text','','','160','1');");
E_D("replace into `ecs_shop_config` values('305','3','thumb_height','text','','','160','1');");
...
E_D("replace into `ecs_shop_config` values('315','3','bought_goods','text','','','4','1');");
E_D("replace into `ecs_shop_config` values('316','3','article_number','text','','','8','1');");
E_D("replace into `ecs_shop_config` values('317','3','goods_name_length','text','','','7','1');");
E_D("replace into `ecs_shop_config` values('318','3','price_format','select','0,1,2,3,4,5','','1','1');");
E_D("replace into `ecs_shop_config` values('319','3','page_size','text','','','10','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','西蒙,奥普,志邦,圣象,喜临门','0');");
E_D("replace into `ecs_shop_config` values('332','3','related_goods_number','text','','','4','1');");
E_D("replace into `ecs_shop_config` values('333','3','help_open','select','0,1','','0','1');");
...
E_D("replace into `ecs_shop_config` values('422','4','invoice_type','manual','','','a:2:{s:4:\"type\";a:3:{i:0;s:0:\"\";i:1;s:0:\"\";i:2;s:0:\"\";}s:4:\"rate\";a:3:{i:0;d:0;i:1;d:0;i:2;d:0;}}','1');");
E_D("replace into `ecs_shop_config` values('423','4','stock_dec_time','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('424','4','cart_confirm','options','1,2,3,4','','3','0');");
...
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','jumei','1');");
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1350912455','1');");
...
E_D("replace into `ecs_shop_config` values('617','6','captcha','hidden','','','45','1');");
E_D("replace into `ecs_shop_config` values('618','6','captcha_width','hidden','','','145','1');");
E_D("replace into `ecs_shop_config` values('619','6','captcha_height','hidden','','','50','1');");
...
E_D("replace into `ecs_shop_config` values('704','7','show_goodsnumber','select','1,0','','0','1');");
...
E_D("replace into `ecs_shop_config` values('801','8','sms_shop_mobile','text','','','15380809984','1');");
E_D("replace into `ecs_shop_config` values('802','8','sms_order_placed','select','1,0','','1','1');");
E_D("replace into `ecs_shop_config` values('803','8','sms_order_payed','select','1,0','','1','1');");
E_D("replace into `ecs_shop_config` values('804','8','sms_order_shipped','select','1,0','','1','1');");
